    ...
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-gray-900 to-black">
        <div className="text-center max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-4">{t.hero.subtitle}</p>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">{t.hero.description}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#contacto" className="bg-blue-brand hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition">{t.hero.cta1}</a>
            <a href="tel:3463070407" className="border border-blue-brand text-blue-brand hover:bg-blue-brand hover:text-white px-8 py-3 rounded-lg font-semibold transition">{t.hero.cta2}</a>
          </div>
        </div>
      </section>
      ...
      <section id="servicios" className="py-20 px-4 max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">{t.servicios.title1} <span className="text-blue-brand">{t.servicios.title2}</span></h2>
        <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">{t.servicios.subtitle}</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-blue-brand transition group">
              ...
              <h3 className="font-semibold text-lg">{t.servicios.items[i]}</h3>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="paquetes" className="py-20 px-4 bg-gray-950">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">{t.paquetes.title1} <span className="text-blue-brand">{t.paquetes.title2}</span></h2>
          <p className="text-gray-400 text-center mb-12">{t.paquetes.subtitle}</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { price: '$60', featured: false },
              { price: '$120', featured: false },
              { price: '$180', featured: false },
              { price: '$250', featured: true },
            ].map((p, i) => (
              <div key={i} className={`rounded-xl p-6 border ${p.featured ? 'bg-blue-brand/10 border-blue-brand scale-105' : 'bg-gray-900 border-gray-800'} flex flex-col items-center text-center`}>
                ...
                <h3 className="text-xl font-bold mb-2">{t.paquetes.items[i]}</h3>
                <p className="text-gray-400 text-sm mb-4">{t.paquetes.desde}</p>
                <p className="text-4xl font-bold text-blue-brand mb-6">{p.price}</p>
                <a href="#contacto" className={`w-full py-2 rounded-lg font-semibold transition text-center ${p.featured ? 'bg-blue-brand text-white hover:bg-blue-700' : 'border border-gray-600 text-gray-300 hover:border-blue-brand hover:text-blue-brand'}`}>{t.paquetes.reservar}</a>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t.porQue.title1} <span className="text-blue-brand">{t.porQue.title2}</span></h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="flex items-start gap-4">
              ...
              <p className="text-gray-300">{t.porQue.items[i]}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="nosotros" className="py-20 px-4 bg-gray-950">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">{t.nosotros.title1} <span className="text-blue-brand">{t.nosotros.title2}</span></h2>
          <p className="text-gray-400 text-lg leading-relaxed">{t.nosotros.text}</p>
        </div>
      </section>

      {/* GALERIA */}
      <section id="galeria" className="py-20 px-4 max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t.galeria.title1} <span className="text-blue-brand">{t.galeria.title2}</span></h2>
      ...
      <section id="testimonios" className="py-20 px-4 bg-gray-950">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t.testimonios.title1} <span className="text-blue-brand">{t.testimonios.title2}</span></h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {t.testimonios.items.map((text, i) => (
      ...
      <section id="contacto" className="py-20 px-4 max-w-3xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t.contacto.title1} <span className="text-blue-brand">{t.contacto.title2}</span></h2>
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={e => e.preventDefault()}>
          <input placeholder={t.contacto.nombre} className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:border-blue-brand outline-none transition" />
          <input placeholder={t.contacto.telefono} className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:border-blue-brand outline-none transition" />
          <input placeholder={t.contacto.vehiculo} className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:border-blue-brand outline-none transition" />
          <select className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:border-blue-brand outline-none transition text-gray-400">
            <option value="">{t.contacto.servicio}</option>
            {t.servicios.items.map((s, i) => <option key={i}>{s}</option>)}
          </select>
          <input type="date" className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:border-blue-brand outline-none transition text-gray-400" />
          <textarea placeholder={t.contacto.mensaje} rows={3} className="sm:col-span-2 bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:border-blue-brand outline-none transition resize-none"></textarea>
          <div className="sm:col-span-2 flex flex-col sm:flex-row gap-4">
            <button type="submit" className="flex-1 bg-blue-brand hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition">{t.contacto.submit}</button>
            <a href="tel:3463070407" className="flex-1 border border-blue-brand text-blue-brand hover:bg-blue-brand hover:text-white py-3 rounded-lg font-semibold transition text-center">{t.contacto.reservar}</a>
          </div>
        </form>
      </section>
      ...
      <footer className="border-t border-gray-800 py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-2">{t.footer.subtitle}</p>
          ...
          <p className="text-gray-600 text-sm mt-8">&copy; {new Date().getFullYear()} Apex Detailing. {t.footer.copyright}</p>
        </div>
      </footer>

      {/* FLOATING CTA - MOBILE */}
      <div className="fixed bottom-4 left-4 right-4 md:hidden flex gap-3 z-50">
        <a href="tel:3463070407" className="flex-1 bg-blue-brand text-white py-3 rounded-lg font-semibold text-center flex items-center justify-center gap-2 shadow-lg"><Phone size={18} /> {t.floating.llamar}</a>
        <a href="#contacto" className="flex-1 bg-white text-black py-3 rounded-lg font-semibold text-center shadow-lg">{t.floating.reservar}</a>
      </div>
    </div>
  )
}
